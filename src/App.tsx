...
import TotalPayments from './pages/TotalPayments';
    ...
    <>
      <Routes>
        ...
        <Route
          ...
          element={
            <>
              <PageTitle title="All Users | TailAdmin - Tailwind CSS Admin Dashboard Template" />
              <AllUsers />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <PageTitle title="Total Payments | TailAdmin - Tailwind CSS Admin Dashboard Template" />
              <TotalPayments />
            </>
          }
        />
        ...
        />
        <Route
          path="/user/:id" // Define the route for user details
          element={
            <>
